...
export const calculateSizes = (isSmall, isMobile, isTablet) => {
  return {
    deskScale: isSmall ? 0.08 : isMobile ? 0.1 : 0.5,
    deskPosition: isMobile ? [0.5, -6.5, 0] : [5, -15, 10],
    statueScale: isSmall ? 1 : isMobile ? 1.5 : 2,
    statuePosition: isMobile ? [0.5, -4.5, 0] : [0.25, 0, 0],
