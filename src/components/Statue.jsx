...
const Statue = (props) => {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/models/rhetorician-1.glb')
  useFrame((delta) => (meshRef.current.rotation.x += delta))
...
useGLTF.preload(('/models/rhetorician-1.glb'))
